...
export default function OverviewVideoSection({
  ...
  return (
    <section id={id} className={`${muted ? "bg-[var(--muted-surface)]" : ""} px-4 pt-12 pb-14 sm:px-6 lg:px-8 lg:pb-[72px]`}>
      <div className="mx-auto grid max-w-[1200px] gap-8 lg:grid-cols-[minmax(0,1.25fr)_minmax(360px,1fr)] lg:items-center">
        <MediaPlaceholder
